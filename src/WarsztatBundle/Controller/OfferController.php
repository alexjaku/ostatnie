...
namespace WarsztatBundle\Controller;

use WarsztatBundle\Entity\Offer;
...
class OfferController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $offers = $em->getRepository('WarsztatBundle:Offer')->findAll();
    ...
    {
        $offer = new Offer();
        $form = $this->createForm('WarsztatBundle\Form\OfferType', $offer);
    ...
    {
        $deleteForm = $this->createDeleteForm($offer);
        $editForm = $this->createForm('WarsztatBundle\Form\OfferType', $offer);
